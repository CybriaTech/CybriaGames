document.write(`
    <footer>
        ...
        <div class="footer-2">
            ...
            <a class="footer-a" href="https://x88.cybriatech.dev" target="_blank">MyBooty165 (X-88)</a>
        </div>
        <div class="footer-3">
        ...
        <p style="color: #fff; font-size: 1.5em; text-align: center;">${new Date().getFullYear()} CybriaTech</p>
    </footer>
`);
